...
$requiredPaths = @(
    ...
    'automation/vagrant/operational/Vagrantfile',
    ...
    'automation/scripts/Test-OperationalConfiguration.ps1',
    ...
    'automation/scripts/Run-ValidationStandbyDns.ps1',
    'automation/scripts/Run-ValidationDnsClient.ps1',
    'automation/scripts/Run-ValidationAdGuardMetrics.ps1',
    'playbooks/preflight.yml',
    'playbooks/bootstrap-rhel.yml',
    'playbooks/docker.yml',
    'playbooks/dns-standby.yml',
    'playbooks/dns-client.yml',
    'playbooks/adguard-metrics.yml',
    ...
    'roles/dns_standby/defaults/main.yml',
    'roles/dns_standby/tasks/main.yml',
    'roles/dns_standby/templates/compose.yaml.j2',
    'roles/dns_standby/README.md',
    'roles/dns_client/defaults/main.yml',
    'roles/dns_client/handlers/main.yml',
    'roles/dns_client/tasks/main.yml',
    'roles/dns_client/README.md',
    'roles/adguard_metrics_user/defaults/main.yml',
    'roles/adguard_metrics_user/handlers/main.yml',
    'roles/adguard_metrics_user/tasks/main.yml',
    'roles/adguard_metrics_user/README.md',
    'roles/adguard_metrics_collector/defaults/main.yml',
    'roles/adguard_metrics_collector/handlers/main.yml',
    'roles/adguard_metrics_collector/tasks/main.yml',
    'roles/adguard_metrics_collector/templates/adguard-metrics.py.j2',
    'roles/adguard_metrics_collector/templates/adguard-metrics.service.j2',
    'roles/adguard_metrics_collector/templates/adguard-metrics.timer.j2',
    'roles/adguard_metrics_collector/README.md',
    'roles/netbox/defaults/main.yml',
    'roles/netbox/tasks/main.yml',
    'roles/netbox/templates/compose.yaml.j2',
    'roles/netbox/templates/provision-demo-inventory.py.j2',
    ...
    'roles/cloudflare_tunnel/templates/compose.yaml.j2',
    'roles/cloudflare_tunnel/README.md',
    'roles/zabbix/defaults/main.yml',
    'roles/zabbix/tasks/main.yml',
    'roles/zabbix/templates/compose.yaml.j2',
    'roles/zabbix/templates/provision-platform-map.py.j2',
    'roles/zabbix/templates/zabbix-agent2-platform.conf.j2',
    ...
    'roles/glpi/templates/compose.yaml.j2',
    'roles/glpi/templates/glpi.env.j2',
    'roles/glpi/templates/custom-php.ini.j2',
    'roles/glpi/README.md',
    'roles/glpi_backup/defaults/main.yml',
    'roles/glpi_backup/handlers/main.yml',
    'roles/glpi_backup/tasks/main.yml',
    'roles/glpi_backup/templates/glpi-backup.sh.j2',
    'roles/glpi_backup/templates/glpi-backup.service.j2',
    'roles/glpi_backup/templates/glpi-backup.timer.j2',
    'roles/glpi_backup/README.md',
    'roles/zabbix_glpi_bridge/defaults/main.yml',
    'roles/zabbix_glpi_bridge/tasks/main.yml',
    'roles/zabbix_glpi_bridge/templates/compose.yaml.j2',
    'roles/zabbix_glpi_bridge/templates/provision-glpi-oauth.php.j2',
    'roles/zabbix_glpi_bridge/templates/zabbix-glpi-bridge.py.j2',
    'roles/zabbix_glpi_bridge/README.md',
    ...
    'roles/observability/templates/glpi-itsm-health.json.j2',
    ...
    'scripts/fixtures/http-contract.json',
    ...
    'docs/runbooks/dns-proxy-contingency.md',
    'docs/decisions/ADR-005-resilience-and-contingency.md',
    'docs/service-criticality.md',
    'docs/reliability-objectives.md',
    'docs/deployment/operational-environment.md',
    'docs/deployment/from-zero-checklist.md',
    'docs/testing/glpi-integrations-validation-evidence.md',
    'docs/migration/legacy-to-iop.md',
    'docs/migration/data-migration-matrix.md',
